      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-y-auto">
          <div className="max-w-3xl mx-auto px-8 py-12">
            <h1 className="text-3xl font-bold text-[#e4e1ed] mb-8">Help & Documentation</h1>
            
            <div className="space-y-6">
              <section className="bg-[#151517] border border-[#27272A] rounded-xl p-6">
                <h2 className="text-lg font-semibold text-[#e4e1ed] mb-4">Getting Started</h2>
                <div className="space-y-3">
                  <Link
                    to="/help/getting-started"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Quick Start Guide</h3>
                    <p className="text-sm text-[#c7c4d7]">Learn the basics of Synclab in 5 minutes</p>
                  </Link>
                  <Link
                    to="/help/creating-documents"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Creating Documents</h3>
                    <p className="text-sm text-[#c7c4d7]">How to create and organize your documents</p>
                  </Link>
                  <Link
                    to="/help/collaboration"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Real-time Collaboration</h3>
                    <p className="text-sm text-[#c7c4d7]">Working with others on the same document</p>
                  </Link>
                </div>
              </section>
              
              <section className="bg-[#151517] border border-[#27272A] rounded-xl p-6">
                <h2 className="text-lg font-semibold text-[#e4e1ed] mb-4">Features</h2>
                <div className="space-y-3">
                  <Link
                    to="/help/offline-first"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Offline-First Editing</h3>
                    <p className="text-sm text-[#c7c4d7]">How Synclab works without internet</p>
                  </Link>
                  <Link
                    to="/help/crdt"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">CRDT Technology</h3>
                    <p className="text-sm text-[#c7c4d7]">Understanding Conflict-free Replicated Data Types</p>
                  </Link>
                  <Link
                    to="/help/sync"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Synchronization</h3>
                    <p className="text-sm text-[#c7c4d7]">How your data stays in sync across devices</p>
                  </Link>
                </div>
              </section>
              
              <section className="bg-[#151517] border border-[#27272A] rounded-xl p-6">
                <h2 className="text-lg font-semibold text-[#e4e1ed] mb-4">Reference</h2>
                <div className="space-y-3">
                  <Link
                    to="/help/keyboard-shortcuts"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Keyboard Shortcuts</h3>
                    <p className="text-sm text-[#c7c4d7]">Complete list of keyboard shortcuts</p>
                  </Link>
                  <Link
                    to="/help/command-palette"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Command Palette</h3>
                    <p className="text-sm text-[#c7c4d7]">Master the ⌘K / Ctrl+K shortcuts</p>
                  </Link>
                  <Link
                    to="/help/markdown"
                    className="block p-4 bg-[#1b1b23] border border-[#27272A] rounded-lg hover:border-[#464554] transition-colors"
                  >
                    <h3 className="font-medium text-[#e4e1ed] mb-1">Markdown Support</h3>
                    <p className="text-sm text-[#c7c4d7]">Supported markdown syntax and extensions</p>
                  </Link>
                </div>
              </section>
              
              <section className="bg-[#151517] border border-[#27272A] rounded-xl p-6">
                <h2 className="text-lg font-semibold text-[#e4e1ed] mb-4">Support</h2>
                <div className="space-y-3">
                  <a
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-medium text-[#e4e1ed] mb-1">Report an Issue</h3>
                      <p className="text-sm text-[#c7c4d7]">File a bug report on GitHub</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-medium text-[#e4e1ed] mb-1">Join Discord</h3>
                      <p className="text-sm text-[#c7c4d7]">Chat with the community</p>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-medium text-[#e4e1ed] mb-1">Email Support</h3>
