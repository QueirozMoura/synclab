...
import { DocumentOperationType, isCreateDocumentOperation, isUpdateTitleOperation, isUpdateContentOperation, isDeleteDocumentOperation, } from "../src/domain/document-operations/DocumentOperation.js";
describe("DocumentOperationAdapter", () => {
    ...
    describe("canAdapt", () => {
        ...
        it("deve retornar false para tipo inválido", () => {
            const op = createSyncOperation("INVALID_TYPE", {
                type: "INVALID_TYPE",
                foo: "bar",
            });
    ...
    describe("DocumentOperationAdapterError", () => {
        ...
        it("deve ter nome correto", () => {
            ...
            try {
                ...
                expect(error.name).toBe("DocumentOperationAdapterError");
            }
        });
        it("deve conter mensagem descritiva", () => {
            ...
            try {
                ...
                expect(error.message).toContain("non-empty title");
            }
        });
    });
});
