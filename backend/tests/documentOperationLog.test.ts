...
describe("DocumentOperationLog", () => {
  ...
  function createCreateOp(id: string, documentId: string = "doc-1"): CreateDocumentOperationParams & { type: DocumentOperationType; payload: { type: DocumentOperationType.CREATE_DOCUMENT; title: string; content: string } } {
    return {
      documentId,
      deviceId: "device-A",
  ...
  function createUpdateTitleOp(id: string, documentId: string = "doc-1"): UpdateTitleOperationParams & { type: DocumentOperationType; payload: { type: DocumentOperationType.UPDATE_TITLE; title: string } } {
    return {
      documentId,
      deviceId: "device-A",
      timestamp: validTimestamp,
  ...
  function createUpdateContentOp(id: string, documentId: string = "doc-1"): UpdateContentOperationParams & { type: DocumentOperationType; payload: { type: DocumentOperationType.UPDATE_CONTENT; content: string } } {
    return {
      documentId,
      deviceId: "device-A",
      timestamp: validTimestamp,
  ...
  function createDeleteOp(id: string, documentId: string = "doc-1"): DeleteDocumentOperationParams & { type: DocumentOperationType; payload: { type: DocumentOperationType.DELETE_DOCUMENT; deleted: true } } {
    return {
      documentId,
      deviceId: "device-A",
      timestamp: validTimestamp,
  ...
  function makeOp(type: DocumentOperationType, id: string, documentId: string = "doc-1") {
    switch (type) {
