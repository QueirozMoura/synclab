...
import { DocumentOperationType, createDocumentOperation, createDocumentOperationWithId, createCreateDocumentOperation, createUpdateTitleOperation, createUpdateContentOperation, createDeleteDocumentOperation, isCreateDocumentOperation, isUpdateTitleOperation, isUpdateContentOperation, isDeleteDocumentOperation, documentOperationToVectorClock, } from "../src/domain/document-operations/index.js";
describe("DocumentOperation Domain Model", () => {
    ...
    describe("CREATE_DOCUMENT", () => {
        ...
        it("deve lançar erro se title estiver vazio", () => {
            expect(() => createCreateDocumentOperation({
                documentId: "doc-1",
                deviceId: "device-A",
                title: "",
                content: "Content",
        ...
        it("deve lançar erro se content não for string", () => {
            expect(() => createDocumentOperation({
                id: "op-1",
                documentId: "doc-1",
                deviceId: "device-A",
    ...
    describe("UPDATE_TITLE", () => {
        ...
        it("deve lançar erro se title estiver vazio", () => {
            expect(() => createUpdateTitleOperation({
                documentId: "doc-1",
                deviceId: "device-A",
                title: "",
                timestamp: validTimestamp,
    ...
    describe("Múltiplos dispositivos", () => {
        it("deve suportar operações de 3 dispositivos diferentes", () => {
            ...
            const ops = devices.map((deviceId, index) => createUpdateTitleOperation({
                documentId: "doc-1",
                deviceId,
                title: `Title ${index}`,
                timestamp: validTimestamp,
