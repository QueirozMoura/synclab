...
import { SyncOperationType, isCreateDocumentPayload, isUpdateTitlePayload, isUpdateContentPayload, isDeleteDocumentPayload, } from "../src/types/syncOperation.js";
import { isValidSyncOperationType, isValidTimestamp, isValidClockMap, } from "../src/types/sync.js";
...
describe("SyncPayload", () => {
    ...
    const validTimestamp = "2024-01-15T10:30:00.000Z";
    const createOperation = (type, payload) => ({
